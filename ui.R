                  ...
                  tabPanel("Phenotype scores",
                           ...
                           fluidRow(
                              ...
                              box(title="First set the phenotype scores for your patients", 
                                  ...
                                  collapsed = TRUE, 
                                  width = 12,
                                  p(h4("Neurodevelopmental scores", tippy(icon("question-circle"),
                                                                           tooltip = h5(HTML(paste0(strong("Adaptive/Cognitive"))), br(),
                                                                                        HTML(paste0("0 = Normal cognition")), br(),
                                                                                        HTML(paste0("3 = Mild delay")), br(),
                                                                                        HTML(paste0("5 = Moderate to profound delay")), br(), br(),
                                                                                        HTML(paste0(strong("Verbal language"))), br(),
                                                                                        HTML(paste0("0 = Speaks more than 10 words")), br(),
                                                                                        HTML(paste0("3 = 10 or fewer spoken words")), br(), br(),
                                                                                        HTML(paste0(strong("Expressive language"))), br(),
                                                                                        HTML(paste0("0 = Fullsentences, can participate in conversational exchanges")), br(),
                                                                                        ...
                                                                                        HTML(paste0("5 = No conventional gestures")), br(), br(),
                                                                                        HTML(paste0(strong("Ambulation"))), br(),
                                                                                        ...
                                                                                        HTML(paste0("4 = Walks alone 8 years or older than 8 years and not acquired")), br(), br(),
                                                                                        HTML(paste0(strong("Behavior"))), br(),
                                                                                        ...
                                                                                        HTML(paste0("4 = Multiple outbursts daily, severe aggresion resulting in multiple injuries, may require more than 2 behavioral medications")), br(), br(),
                                                                                        HTML(paste0(strong("Sleep disturbance"))), br(),
                                                                                        ...
                                                                                        HTML(paste0("3 = Significant disruption, requiring more than one sleep medication")), align = "left"),
                                                                           animation = "scale",
                                                                           theme = "light"))),
                                  column(3,
                                         selectInput("neuro1",
                                  ...
                                  column(12, align = "left",
                                    p(h4("Clinical scores", tippy(icon("question-circle"),
                                                                  tooltip = h5(HTML(paste0(strong("Palate"))), br(),
                                                                               HTML(paste0("0 = Intact palate, high arched, bifid uvula")), br(),
                                                                               HTML(paste0("2 = Cleft palate")), br(), br(),
                                                                               HTML(paste0(strong("Sialorrhea"))), br(),
                                                                               HTML(paste0("0 = Normal drooling")), br(),
                                                                               HTML(paste0("1 = Excessive drooling after 2 years of age with no intervention needed")), br(),
                                                                               HTML(paste0("2 = Excessive drooling after 2 years of age requiring intervention")), br(), br(),
                                                                               HTML(paste0(strong("Strabismus"))), br(),
                                                                               HTML(paste0("0 = Not present")), br(),
                                                                               HTML(paste0("1 = Present, no intervention needed by 2 years of age")), br(),
                                                                               HTML(paste0("2 = Present and patching or surgery needed at any age")), br(), br(),
                                                                               HTML(paste0(strong("Scoliosis"))), br(),
                                                                               ...
                                                                               HTML(paste0("2 = Severe, clearly visible by examination or spine surgery needed")), br(), br(),
                                                                               HTML(paste0(strong("Muscle tone (past or present, first 5 years"))), br(),
                                                                               HTML(paste0("0 = Normal")), br(),
                                                                               HTML(paste0("1 = Tone mildy abnormal")), br(),
                                                                               HTML(paste0("2 = Severe or generalized hypotonia, dystonia, or hypertonia")), br(), br(),
                                                                               HTML(paste0(strong("Bone health"))), br(),
                                                                               ...
                                                                               HTML(paste0("3 = One or multiple unexplained fractures, needing bone resorption inhibitors")), br(), br(),
                                                                               HTML(paste0(strong("Somatic growth and feeding"))), br(),
                                                                               HTML(paste0("0 = No growth failure")), br(),
                                                                               HTML(paste0("1 = Weight between -1 and -2 SD (3% <w< 25%) or Weight for length/BMI <2SD (<3%)")), br(),
                                                                               HTML(paste0("2 = Weight below sSD (<3%)")), br(),
                                                                               HTML(paste0("3 = Gastrostomy tube (G-tube) needed regardless of growth")), br(), br(),
                                                                               HTML(paste0(strong("Epilepsy/Seizures"))), br(),
                                                                               ...
                                                                               HTML(paste0("2 = Current uncontrolled (>1x/month) seizures or needs more than 1 antiepileptic medication to control")), br(), br(),
                                                                               HTML(paste0(strong("Dental"))), br(),
