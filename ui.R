                                         ...
                                         selectInput("clinical5",
                                                     p("Scoliosis", tippy(icon("question-circle"), 
                                                                        tooltip = h5(HTML(paste0(strong("Scoliosis"))), br(),
                                                                                     HTML(paste0("0 = Not present or mild, only noticed by X-raysm no interventions needed")), br(),
                                         ...
                                         selectInput("clinical7",
                                                     p("Bone Health", tippy(icon("question-circle"), 
                                                                          tooltip = h5(HTML(paste0(strong("Bone health"))), br(),
                                                                                       ...
                                                                                       HTML(paste0("2 = One or multiple unexplained fractures, not needing bone resorption inhibitors")), br(),
                                                                                       HTML(paste0("3 = One or multiple unexplained fractures, needing bone resorption inhibitors")),
                                                                                       align = "left"), 
                                                                          animation = "scale", 
                                                                          theme = "light")),
