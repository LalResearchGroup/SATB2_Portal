                    ...
                    column(2, align = "center",
                           ...
                           div(panel(
                             ...
                             div(landing_tab3,br(), 
                                 ...
                                 actionBttn(
                                   inputId = "variantBtn",
                                   label = p("Variant Analysis and Severity Scores",
                                            br(),
                                            br()),
                                   color = "royal",
                                   block = TRUE,
              ...
              fluidRow(
                panel(status="default",
                  ...
                  tabPanel("Phenotype scores", 
                           br(),
                           fluidRow(
                              p(h3("Compare phenotype scores to other individuals", tippy(icon("question-circle"), 
                                                                                          tooltip = h5(HTML(paste0("Scores are only calculated for individuals 3 years and older")),
                                                                                                       align = "left"), 
                                                                                          animation = "scale", 
                                                                                          theme = "light")),
                                ),
                              box(title="First set the phenotype scores for your patients", 
                                  collapsible = TRUE, 
                                  collapsed = TRUE, 
                                  width = 12,
                                  ...
                                  column(3,
                                         selectInput("neuro1",
                                                     p("Adaptive/Cognition:", tippy(icon("question-circle"), 
                                                                                    tooltip = h5(HTML(paste0(strong("Adaptive/Cognitive"))), br(),
                                                                                                 HTML(paste0("0 = Normal cognition")), br(),
                                                                                                 HTML(paste0("3 = Mild delay")), br(),
                                                                                                 HTML(paste0("5 = Moderate to profound delay")),
                                                                                                 align = "left"), 
                                                                                    animation = "scale", 
                                                                                    theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("neuro2",
                                                     p("Verbal", tippy(icon("question-circle"), 
                                                                     tooltip = h5(HTML(paste0(strong("Verbal language"))), br(),
                                                                                  HTML(paste0("0 = Speaks more than 10 words")), br(),
                                                                                  HTML(paste0("3 = 10 or fewer spoken words")),
                                                                                  align = "left"), 
                                                                     animation = "scale", 
                                                                     theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("neuro3",
                                                     p("Expressive", tippy(icon("question-circle"), 
                                                                        tooltip = h5(HTML(paste0(strong("Expressive language"))), br(),
                                                                                     HTML(paste0("0 = Full sentences, can participate in conversational exchanges")), br(),
                                                                                     HTML(paste0("1 = >50 words/signs/pictures/symbols")), br(),
                                                                                     HTML(paste0("2 = 10-50 words/signs/pictures/symbols")), br(),
                                                                                     HTML(paste0("3 = 1-10 spontaneous words/signs/pictures/symbols")), br(),
                                                                                     HTML(paste0("4 = Communicates with some conventional gestures")), br(),
                                                                                     HTML(paste0("5 = No conventional gestures")),
                                                                                     align = "left"),
                                                                        animation = "scale", 
                                                                        theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("neuro4",
                                                     p("Ambulation", tippy(icon("question-circle"), 
                                                                         tooltip = h5(HTML(paste0(strong("Ambulation"))), br(),
                                                                                      HTML(paste0("0 = Acquired <18 months")), br(),
                                                                                      HTML(paste0("1 = Walks alone 18-29 months")), br(),
                                                                                      HTML(paste0("2 = Walks alone 29-59 months")), br(),
                                                                                      HTML(paste0("3 = Walks alone 59 months (5 years) to 8 years")), br(),
                                                                                      HTML(paste0("4 = Walks alone 8 years or older than 8 years and not acquired")),
                                                                                      align = "left"), 
                                                                         animation = "scale", 
                                                                         theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("neuro5",
                                                     p("Behavior", tippy(icon("question-circle"), 
                                                                       tooltip = h5(HTML(paste0(strong("Behavior"))), br(),
                                                                                    HTML(paste0("0 = No behavior concerns")), br(),
                                                                                    HTML(paste0("1 = Mild (hyperactivity, poor boundaries, sensory - scratching/pulling hair)")), br(),
                                                                                    HTML(paste0("2 = Moderately intense outbursts, 2-4 times a week")), br(),
                                                                                    HTML(paste0("3 = Multiple outbursts daily, physical aggresion towards self or others, may require 1-2 bevioral medications (e.g., stimulants, antipsychotics, etc.")), br(),
                                                                                    HTML(paste0("4 = Multiple outbursts daily, severe aggresion resulting in multiple injuries, may require more than 2 behavioral medications")),
                                                                                    align = "left"), 
                                                                       animation = "scale", 
                                                                       theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("neuro6",
                                                     p("Sleep", tippy(icon("question-circle"), 
                                                                    tooltip = h5(HTML(paste0(strong("Sleep disturbance"))), br(),
                                                                                 HTML(paste0("0 = Normal sleep pattern")), br(),
                                                                                 HTML(paste0("1 = Present some disruptions, no medications needed")), br(),
                                                                                 HTML(paste0("2 = Significant disruption, requiring single sleep medication")), br(),
                                                                                 HTML(paste0("3 = Significant disruption, requiring more than one sleep medication")),
                                                                                 align = "left"), 
                                                                    animation = "scale", 
                                                                    theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("clinical1",
                                                     p("Palate", tippy(icon("question-circle"), 
                                                                     tooltip = h5(HTML(paste0(strong("Palate"))), br(),
                                                                                  HTML(paste0("0 = Intact palate, high arched, bifid uvula")), br(),
                                                                                  HTML(paste0("2 = Cleft palate")),
                                                                                  align = "left"), 
                                                                     animation = "scale", 
                                                                     theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("clinical3",
                                                     p("Sialorrhea", tippy(icon("question-circle"), 
                                                                         tooltip = h5(HTML(paste0(strong("Sialorrhea"))), br(),
                                                                                      HTML(paste0("0 = Normal drooling")), br(),
                                                                                      HTML(paste0("1 = Excessive drooling after 2 years of age with no intervention needed")), br(),
                                                                                      HTML(paste0("2 = Excessive drooling after 2 years of age requiring intervention")),
                                                                                      align = "left"), 
                                                                         animation = "scale", 
                                                                         theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("clinical4",
                                                     p("Strabismus", tippy(icon("question-circle"), 
                                                                         tooltip = h5(HTML(paste0(strong("Strabismus"))), br(),
                                                                                      HTML(paste0("0 = Not present")), br(),
                                                                                      HTML(paste0("1 = Present, no intervention needed by 2 years of age")), br(),
                                                                                      HTML(paste0("2 = Present and patching or surgery needed at any age")),
                                                                                      align = "left"), 
                                                                         animation = "scale", 
                                                                         theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("clinical5",
                                                     p("Scoliosis", tippy(icon("question-circle"), 
                                                                        tooltip = h5(HTML(paste0(strong("Scoliosis"))), br(),
                                                                                     HTML(paste0("0 = Not present or mild, only noticed by X-rays no interventions needed")), br(),
                                                                                     HTML(paste0("1 = Moderate, noticed by both clinical examination and X-rays, brace needed")), br(),
                                                                                     HTML(paste0("2 = Severe, clearly visible by examination or spine surgery needed")),
                                                                                     align = "left"), 
                                                                        animation = "scale", 
                                                                        theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("clinical6",
                                                     p("Muscle Tone", tippy(icon("question-circle"), 
                                                                          tooltip = h5(HTML(paste0(strong("Muscle tone (past or present, first 5 years)"))), br(),
                                                                                       HTML(paste0("0 = Normal")), br(),
                                                                                       HTML(paste0("1 = Tone mildy abnormal")), br(),
                                                                                       HTML(paste0("2 = Severe or generalized hypotonia, dystonia, or hypertonia")),
                                                                                       align = "left"), 
                                                                          animation = "scale", 
                                                                          theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("clinical7",
                                                     p("Bone Health", tippy(icon("question-circle"), 
                                                                          tooltip = h5(HTML(paste0(strong("Bone health"))), br(),
                                                                                       HTML(paste0("0 = Normal, no previous fractures")), br(),
                                                                                       HTML(paste0("1 = Only explainable traumatic fractures")), br(),
                                                                                       HTML(paste0("2 = One or multiple unexplained fractures, not needing bone resorption inhibitors (bisphosphonates)")), br(),
                                                                                       HTML(paste0("3 = One or multiple unexplained fractures, needing bone resorption inhibitors (bisphosphonates)")),
                                                                                       align = "left"), 
                                                                          animation = "scale", 
                                                                          theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("clinical8",
                                                     p("Growth/Feeding", tippy(icon("question-circle"), 
                                                                             tooltip = h5(HTML(paste0(strong("Somatic growth and feeding"))), br(),
                                                                                          HTML(paste0("0 = No growth failure")), br(),
                                                                                          HTML(paste0("1 = Weight between -1 and -2 SD (3% < w < 25%) or Weight for length/BMI <2SD (<3%)")), br(),
                                                                                          HTML(paste0("2 = Weight below 2 SD (<3%)")), br(),
                                                                                          HTML(paste0("3 = Gastrostomy tube (G-tube) needed regardless of growth")),
                                                                                          align = "left"), 
                                                                             animation = "scale", 
                                                                             theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("clinical9",
                                                     p("Seizures", tippy(icon("question-circle"), 
                                                                         tooltip = h5(HTML(paste0(strong("Epilepsy/Seizures"))), br(),
                                                                                      HTML(paste0("0 = No clinical seizures")), br(),
                                                                                      HTML(paste0("1 = Previous suspected/confirmed seizures or current well-controlled (<1x month) with a single antiepileptic")), br(),
                                                                                      HTML(paste0("2 = Current uncontrolled (>1x/month) seizures or needs more than 1 antiepileptic medication to control")),
                                                                                      align = "left"), 
                                                                         animation = "scale", 
                                                                         theme = "light")),
                                  ...
                                  column(3,
                                         selectInput("clinical10",
                                                     p("Dental", tippy(icon("question-circle"), 
                                                                         tooltip = h5(HTML(paste0(strong("Dental"))), br(),
                                                                                      HTML(paste0("0 = No morphological dental abnormalities")), br(),
                                                                                      HTML(paste0("5 = Any of the following clinical or radiographic findings, 1 point each with a maximum of 5 points: Macrodontia, excessive crowding, delayed eruption, abnormal dental shape, history of dental trauma, missing mandibular 2nd bicuspids, missing maxillary 2nd bicuspids, lack of 6-year molars root development, severely rotated teeth")),
                                                                                      align = "left"), 
                                                                         animation = "scale", 
                                                                         theme = "light")),
                          ...
                          tabPanel("General Information",
                                   ...
                                   panel(heading = "Teams and People", status = "default",
                                         ...
                                         fluidRow(
                                           ...
                                           column(3,
                                                  panel(style="height: 230px;",heading = "Acknowledgements",
                                                        div(style="height: 100%",
                                                            p("Jenny-Li Örsell, SATB2 Europe")) #,
                                                            #p("Eduardo Perez-Palma"),
                                                            #p("Marie Mcnee"),
                                                            #p("Patrick May"),
                                                            #p("Chiara Klöckner")) #,
